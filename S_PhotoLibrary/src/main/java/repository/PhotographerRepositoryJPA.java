...
/**
 * PhotographerRepositoryJPA implements the CRUD operations on the entity.
 * For improving performance the EntityManager created in the DatabaseContext
 * is reused.
 * All operations are executed in a separate transaction.
 * @author jprie
 *
 */
