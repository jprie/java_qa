...
@Entity
@Access(AccessType.PROPERTY) // define that we are using properties
public class Photo {

	// define the names for the properties being used in the ValuePropertyFactory for
	// the TableCellFactory
	public static final String NAME_NAME = "name";
	public static final String DATE_NAME = "date";
	public static final String LOCATION_NAME = "location";

	// attributes are stored in properties to allow for easier access in the controller
	...
	// Columns are annotated with the getters to automatically unpack the properties
	...
	/**
	 * One photo has one photographer BUT one photographer has many photos
	 * the column where the photographer is stored is named photographer_id
	 * in the database!
	 * @return
	 */
